...
import { View, TextInput, Dimensions, Text, StyleSheet, Image, TouchableOpacity, TextInputComponent, Alert } from "react-native";
...
export default function FeedBack() {
        ...
        return (
            <View style={styles.popupContainer}>
                <View style={styles.popupCard}>
                    ...
                    <Text style={[styles.text2, styles.commonText]}>to provide better service! </Text>
    ...
    function Prev() {
        return (
            <TouchableOpacity style={styles.headerContainer} onPress={() => navigation.navigate('Mypage')}>
        ...
        <View style={{ flex: 1, backgroundColor: "#FFF" }}>
            ...
            <View style={{ marginHorizontal: 25 }}>
                ...
                <TextInput
                    ...
                    placeholder="Please enter a title" placeholderTextColor={"#BFBFBF"}></TextInput>
                ...
                <TextInput
                    ...
                    placeholder="Please enter details" placeholderTextColor={"#AAA"}></TextInput>
            </View>
