  ...
  const selectInfos = [
    {
      ...
      description: "You can check the exchange rate!",
      img: require("../../assets/images/calculator.png"),
    },
    {
      path: "TranslationTest",
      title: "Australia Culture Quiz",
      description: "You can take an Australian culture quiz!",
      img: require("../../assets/images/message.png"),
    },
    {
      path: "SelectTest",
      title: "English practice",
      description: "You can learn expressions!",
      img: require("../../assets/images/koreaEnglish.png"),
    },
  ];
  return (
